...
const D2 = {value: 2, name: "Diamantna 2"};
const D3 = {value: 3, name: "Diamantna 3"};
const D4 = {value: 4, name: "Diamantna 4"};
const D5 = {value: 5, name: "Diamantna 5"};
const D6 = {value: 6, name: "Diamantna 6"};
const D7 = {value: 7, name: "Diamantna 7"};
const D8 = {value: 8, name: "Diamantna 8"};
const D9 = {value: 9, name: "Diamantna 9"};
const D10 = {value: 10, name: "Diamantna 10"};
const DJ = {value: 11, name: "Diamantni Fant"};
const DQ = {value: 12, name: "Diamantna Kraljica"};
const DK = {value: 13, name: "Diamantni Kralj"};
const DA = {value: 14, name: "Diamantni As"};
